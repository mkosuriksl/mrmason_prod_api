...
//	}
	...
	public List<AdminPopTasksManagemnt> updateAdmin(List<AdminPopTasksManagemnt> taskList) {
		AdminInfo userInfo = getLoggedInAdminInfo();
		List<AdminPopTasksManagemnt> updatedTasks = new ArrayList<>();

		for (AdminPopTasksManagemnt dto : taskList) {
			AdminPopTasksManagemnt existing = repository.findById(dto.getAdminTaskId())
