...
@AllArgsConstructor
@NoArgsConstructor
public class MaterialHeaderAndDetailedDto {

    List<MaterialHeaderDto> materialHeader;
    List<MaterialHeaderDetailedDto> materialHeaderDetailed;

    @Data
    @Builder
    @AllArgsConstructor
    @NoArgsConstructor
    public static class MaterialHeaderDto {
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class MaterialHeaderDetailedDto{
