...
public class MaterialSupplierQuotationUserService {
    ...
    public Optional<MaterialSupplierQuotationUser> checkExistingUser(
            String email,
            String phone,
            RegSource regSource) {

        List<MaterialSupplierQuotationUser> users =
                userDAO.findByEmailANDMobile(
                        email,
                        phone
                );
        ...
        return users.stream()
                .filter(user ->
                        user.getRegSource() != null
                        && user.getRegSource().equals(regSource))
                .findFirst();
    }
    ...
    public Userdto addDetails(
            MaterialSupplierQuotationUser user) {

        String encryptPassword =
                byCrypt.encode(user.getPassword());
        ...
        String emailMessage =
                "Thanks for registering with us. please verify your registered email and mobile.";
        ...
        MaterialSupplierQuotationUser data =
                userDAO.save(user);


        // Login table
        MaterialSupplierQuotationLogin service =
                new MaterialSupplierQuotationLogin();
        ...
        // Admin verification
        AdminMsVerification verification =
                new AdminMsVerification();

        verification.setBodSeqNo(
                data.getBodSeqNo()
        );

        verification.setStatus("new");
        verification.setComment("");
        verification.setUpdateBy(
                data.getBodSeqNo()
        );
        verification.setUpdatedDate(
                new Date()
        );

        adminMSVerificationRepository.save(
                verification
        );
        ...
        dto.setServiceCategory(
                user.getServiceCategory()
        );

        if (user.getRegSource() != null) {
            dto.setRegSource(
                    user.getRegSource().toString()
            );
        }
    ...
    public ResponseSpLoginDto loginDetails(
            LoginRequest login) {

        ResponseSpLoginDto response =
                new ResponseSpLoginDto();


        Optional<MaterialSupplierQuotationLogin> loginDb =
                materialSupplierQuotatuionLoginDAO
                        .findByEmailOrMobileAndRegSource(
                                login.getEmail(),
                                login.getMobile(),
                                login.getRegSource()
                        );
        ...
        Optional<MaterialSupplierQuotationUser>
                userEmailMobile =
                userDAO.findByEmailOrMobileAndRegSource(
                        login.getEmail(),
                        login.getMobile(),
                        login.getRegSource()
                );
        ...
        if (login.getEmail() != null
                && login.getMobile() == null) {

            if (!"yes".equalsIgnoreCase(
                    loginDb.get().getEVerify())) {
    ...
    public Userdto getServiceProfile(
            String bodSeqNo) {

        Optional<MaterialSupplierQuotationUser> user =
                Optional.ofNullable(
                        userDAO.findByBodSeqNo(
                                bodSeqNo
                        )
                );
        ...
        MaterialSupplierQuotationUser userdb =
                user.get();


        List<MsServiceDetails> serviceDetails =
                detailsRepo.findByUserId(
                        userdb.getBodSeqNo()
                );
        ...
        if (userdb.getRegSource() != null) {
            dto.setRegSource(
                    userdb.getRegSource().toString()
            );
        }
        ...
        dto.setRegisteredDate(
                userdb.getRegisteredDate()
        );

        dto.setUpdatedDate(
                userdb.getUpdatedDate()
        );

        dto.setServiceCategory(
                userdb.getServiceCategory()
        );

        userProfilemageRepository
                .findByBodSeqNo(bodSeqNo)
                .ifPresent(upload ->
                        dto.setPhoto(
                                upload.getPhoto()
                        )
        ...
        adminMSVerificationRepository
                .findByBodSeqNo(bodSeqNo)
                .ifPresent(statusData ->
                        dto.setVerifiedStatus(
                                statusData.getStatus()
                        )
                );

        dto.setLinkedInURL(
                userdb.getLinkedInURL()
        );

        dto.setHighestQualification(
                userdb.getHighestQualification()
        );
    ...
    public Userdto getServiceProfile(
        ...
        Optional<MaterialSupplierQuotationUser> user =
                userDAO.findByEmailAndRegSource(
                        email,
                        regSource
                );
        ...
        List<MsServiceDetails> serviceDetail =
                detailsRepo.findByUserIdAndStatus(
                        userdb.getBodSeqNo(),
                        "active"
                );
    ...
    public String sendMail(
        ...
        Optional<MaterialSupplierQuotationUser> userOp =
                userDAO.findByEmailAndRegSource(
                        email,
                        regSource
                );
    ...
    public String sendSms(
        ...
        Optional<MaterialSupplierQuotationUser> userOp =
                userDAO.findByMobileAndRegSource(
                        mobile,
                        regSource
                );
        ...
        if (userOp.isPresent()) {
            ...
            if ("active".equalsIgnoreCase(
                ...
                otpService.generateMsMobileOtp(
                        mobile,
                        regSource
                );
    ...
    public String changePassword(
        ...
        String encryptPassword =
                byCrypt.encode(confirmPassword);
    ...
    public String forgetPassword(
        ...
        Optional<MaterialSupplierQuotationUser> userEmail =
                userDAO.findByEmailAndRegSource(
                        email,
                        regSource
                );

        Optional<MaterialSupplierQuotationUser> userMobile =
                userDAO.findByMobileAndRegSource(
                        mobile,
                        regSource
                );
        ...
        if (userEmail.isPresent()) {
            ...
            String encryptPassword =
                    byCrypt.encode(confPass);

            userEmail.get().setPassword(
                    encryptPassword
            );
    ...
    public MaterialSupplierQuotationUser updateProfile(
            UpdateProfileRequest registrationDetails,
            String bodSeqNo) {

        Optional<MaterialSupplierQuotationUser> existedByEmail =
                Optional.ofNullable(
                        userDAO.findByBodSeqNo(
                                bodSeqNo
                        )
        ...
        user.setLocation(
                registrationDetails.getLocation()
        );

        user.setState(
                registrationDetails.getState()
        );

        user.setDistrict(
                registrationDetails.getDistrict()
        );
        ...
        user.setLinkedInURL(
                registrationDetails.getLinkedInURL()
        );

        user.setHighestQualification(
                registrationDetails.getHighestQualification()
        );
    ...
    @Transactional
    public ResponseEntity<ResponseModel> uploadprofileimage(
            String bodSeqNo,
            MultipartFile photo,
            RegSource regSource)
            throws AccessDeniedException {
        ...
        if (!UserType.MS.name()
            ...
            throw new AccessDeniedException(
                    "Only Material Supplier(MS) can access this API."
            );
        }
        ...
        Optional<MaterialSupplierQuotationUser>
                adminMaterial =
                userDAO.findByBodSeqNoUploadImage(
                        bodSeqNo
                );
        ...
        if (adminMaterial.isEmpty()) {
            ...
            response.setMsg(
                    "bodSeqNo ID not found in MaterialSupplierQuotation."
            );
        ...
        UploadUserProfileImage uploadEntity =
                new UploadUserProfileImage();

        uploadEntity.setBodSeqNo(
                bodSeqNo
        );
        ...
        userProfilemageRepository.save(
                uploadEntity
        );
    ...
    // =========================================================
    // GET LOGGED IN MS INFO
    // =========================================================

    private UserInfo getLoggedInSPInfo(
            RegSource regSource) {
