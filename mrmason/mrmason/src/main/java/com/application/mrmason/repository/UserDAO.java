...
public interface UserDAO extends JpaRepository<User, String> {
    ...
    @Query("""
            ...
            """)
    Optional<User> findByEmailAndUserTypeAndRegSource(
            @Param("email") String email,
    ...
    @Query("""
            ...
            AND u.regSource = :regSource
            """)
    Optional<User> findByEmailAndRegSource(
            @Param("email") String email,
            @Param("regSource") RegSource regSource);
    ...
    @Query("""
            ...
            AND u.regSource = :regSource
            """)
    Optional<User> findByMobileAndRegSource(
    ...
    @Query("""
            SELECT u
            FROM User u
            WHERE u.bodSeqNo = :bodSeqNo
            """)
    Optional<User> findByBodSeqNos(
    ...
    List<User> findByEmailOrMobileOrStatusOrderByRegisteredDateDesc(
            String email,
            String mobile,
            String status);


    List<User> findByServiceCategory(
    ...
    @Query("""
            SELECT u
            FROM User u
            WHERE u.registeredDate BETWEEN :startDate AND :endDate
            """)
    List<User> findByRegisteredDateBetween(
    ...
    List<User> findByBodSeqNoIn(
            List<String> bodSeqNo);


    // =========================================================
    // MOBILE OR EMAIL + BOD SEQ NO
    // =========================================================

    @Query("""
            SELECT u
            FROM User u
            WHERE (u.mobile = :contact OR u.email = :contact)
            AND u.bodSeqNo = :userId
            """)
    Optional<User> findByMobileOrEmailAndBodSeqNo(
    ...
    @Query("""
            ...
            AND u.userType = :userType
            """)
    Optional<User> findByEmailAndUserType(
            @Param("email") String email,
            @Param("userType") UserType userType);
    ...
    @Query("""
            ...
            WHERE u.bodSeqNo = :bodSeqNo
            """)
    Optional<User> findByBodSeqNoUploadImage(
            @Param("bodSeqNo") String bodSeqNo);
}